...
export default function ForgotPassword() {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      toast.success(response.data.message || "Instruksi telah dikirim!", {
        id: toastId,
      });
      ...
      const errorMessage =
        ...
        "Gagal mengirim instruksi. Periksa kembali email Anda.";
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#F7F7F7] items-center justify-center px-4 py-10">
      <div className="max-w-md w-full bg-white p-6 sm:p-8 rounded-2xl shadow-lg">
        ...
        <p className="text-center text-gray-600 text-sm mb-8">
          Masukkan alamat email Anda yang terdaftar. Kami akan mengirimkan kode
