...
// Sidebar Component - dipindahkan ke luar agar tidak dibuat ulang setiap render
const Sidebar = ({ activeMenu, setActiveMenu, navigate }) => {
  const handleLogout = () => {
...
// Main Component with Navigation and Logout
const BerandaAdmin = () => {
  ...
  return (
    <div className="flex">
      <Sidebar activeMenu={activeMenu} setActiveMenu={setActiveMenu} navigate={navigate} />
